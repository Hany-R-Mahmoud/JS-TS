...
window.addEventListener("scroll", () => {
    window.scrollY > 100
        ? upBtn === null || upBtn === void 0 ? void 0 : upBtn.classList.add("show")
        : upBtn === null || upBtn === void 0 ? void 0 : upBtn.classList.remove("show");
});
...
window.addEventListener("scroll", () => {
    scroller.style.width = `${(document.documentElement.scrollTop /
...
function slideChecker() {
    ...
    currentImage == 1
        ? slidePrevBtn === null || slidePrevBtn === void 0 ? void 0 : slidePrevBtn.classList.add("disabled")
        : slidePrevBtn === null || slidePrevBtn === void 0 ? void 0 : slidePrevBtn.classList.remove("disabled");
    currentImage == sliderImagesArray.length
        ? slideNextBtn === null || slideNextBtn === void 0 ? void 0 : slideNextBtn.classList.add("disabled")
        : slideNextBtn === null || slideNextBtn === void 0 ? void 0 : slideNextBtn.classList.remove("disabled");
}
slideChecker();
slideNextBtn === null || slideNextBtn === void 0 ? void 0 : slideNextBtn.addEventListener("click", () => {
    !(slideNextBtn === null || slideNextBtn === void 0 ? void 0 : slideNextBtn.classList.contains("disabled"))
        ? currentImage++ && slideChecker()
        : false;
});
slidePrevBtn === null || slidePrevBtn === void 0 ? void 0 : slidePrevBtn.addEventListener("click", () => {
    !(slidePrevBtn === null || slidePrevBtn === void 0 ? void 0 : slidePrevBtn.classList.contains("disabled"))
        ? currentImage-- && slideChecker()
        : false;
});
sliderBulletsArray.forEach((bullet) => {
